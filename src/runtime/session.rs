...
impl SessionRuntime {
    pub fn new(native: NativeSession) -> crate::error::AppResult<Self> {
    ...
    #[allow(dead_code)]
    pub fn refresh_lease(&self) -> crate::error::AppResult<()> {
    ...
    pub fn resolve_m3u8_url(&self, adam: u64) -> crate::error::AppResult<String> {
        self.native
